-- =============================================================================
-- Finora - Full Schema (V1, consolidated - idempotent)
-- =============================================================================
...
CREATE INDEX IF NOT EXISTS idx_investments_isin          ON public.investments(isin);
CREATE INDEX IF NOT EXISTS idx_investments_import_source ON public.investments(import_source);

CREATE UNIQUE INDEX IF NOT EXISTS idx_investments_user_isin
...
CREATE INDEX IF NOT EXISTS idx_sips_isin          ON public.sips(isin);
CREATE INDEX IF NOT EXISTS idx_sips_import_source ON public.sips(import_source);
...
CREATE INDEX IF NOT EXISTS idx_ledger_user_time ON public.ledger_events(user_id, event_sequence);
CREATE INDEX IF NOT EXISTS idx_ledger_entity    ON public.ledger_events(entity_type, entity_id);
...
DROP TRIGGER IF EXISTS ledger_no_update ON public.ledger_events;
